...
#define SSID        "Areter"   //WiFi name
#define PASSWORD    "123456789"   //PASSWORD
#define LINE_TOKEN  "nyj7o5haJ6CKAClWIx6V3YGly4VpFx2wTqVH2G2ukDP"

//#define SSID        "FAMILY"   //WiFi name
//#define PASSWORD    "1212312121"   //PASSWORD
...
void Send_line(uint8_t *image_data, size_t   image_size) {
  LINE.notifyPicture("ประตูถูกเปิด : มีคนเข้าห้อง !!", image_data, image_size);
}
